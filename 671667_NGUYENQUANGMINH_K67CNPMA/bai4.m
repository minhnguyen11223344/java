...
% Last Modified by GUIDE v2.5 27-Sep-2024 10:34:21
...
% varargin   command line arguments to bai4 (see VARARGIN)
...
Txe = get(handles.edit2,'String');% Nh?n chu?i ký t? ? edit2 gán cho k2
Txe = str2num(Txe);
...
set(handles.edit9,'String',sochuyen);
...
set(handles.edit8,'String' ,ket);

set(handles.edit7, 'String',Ndg);
